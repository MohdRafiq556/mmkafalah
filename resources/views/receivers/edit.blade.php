        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('receiver:store', $receiver->id)}}" method="POST"> <!-- bila update penerima, akan tambah jd penerima baru,, aku nak buat dia just update penerima tu je-->
                        @csrf
