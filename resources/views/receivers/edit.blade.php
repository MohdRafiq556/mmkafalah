        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('receiver:update', $receiver->id)}}" method="POST"> <!-- bila update penerima, akan tambah jd penerima baru,, aku nak buat dia just update penerima tu je-->
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 text-right">
                                <a class="btn btn-danger btn-user" href="{{url ('receivers/{id}')}}">Cancel</a> <!-- tak boleh nak balik ke receiver index -->
