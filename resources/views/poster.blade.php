    ...
    <div class="container">
        <div class="row justify-content-start">
            ...
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:400px;" src="{{asset('landingpage2/assets/img/poster-1.jpeg')}}" alt="">
                <p class="lead mb-0 p-2">Darah Daging Menjadi Musuh</p>
            </div>
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:400px;" src="{{asset('landingpage2/assets/img/poster-2.jpeg')}}" alt="">
                <p class="lead mb-0 p-2">Kwsp Hak Siapa???</p>
            </div>
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:400px;" src="{{asset('landingpage2/assets/img/poster-3.jpeg')}}" alt="">
            ...
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:400px;" src="{{asset('landingpage2/assets/img/poster-4.jpeg')}}" alt="">
                <p class="lead mb-0 p-2">Katakan Tidak Pada Harta Batil</p>
            </div>
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:400px;" src="{{asset('landingpage2/assets/img/poster-5.jpg')}}" alt="">
                <p class="lead mb-0 p-2">Jangan Pernah Berniat Tidak Membayar Hutang</p>
            </div>
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:400px;" src="{{asset('landingpage2/assets/img/poster-6.jpg')}}" alt="">
...
<section class="showcase ">
    <div class="container">
        <div class="row justify-content-start">
            ...
            <div class="col-lg-4 p-5">
                <img class="img-fluid" style="width:100%;height:480px;" src="{{asset('landingpage2/assets/img/aktiviti-1.jpg')}}" alt="">
            </div>
