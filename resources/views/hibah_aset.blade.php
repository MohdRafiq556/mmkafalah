...
<section class="showcase">
            ...
            &nbsp;
                <hr>
                <p class="lead mb-0"><strong>Hibah Aset</strong> berbeza dengan <strong>Hibah Takaful</strong>. Perbezaan kedua-dua hibah tersebut adalah harta yang hibahkan didalam akadnya. Bagi <strong> Hibah Takaful </strong>,
                ...
                <hr><h3>KEPENTINGAN HIBAH ASET</h3><hr>
                ...
                <hr>&nbsp;
                <img class="rounded float-start" style="width:620px;height:500px;" src="{{asset('landingpage2/assets/img/hibah-aset_3.png')}}" alt="">
                <img class="rounded float-end" style="width:620px;height:500px;" src="{{asset('landingpage2/assets/img/hibah-aset_4.png')}}" alt="">
