            ...
            &nbsp;
                ...
                <div class="row g-0 bg-secondary">
                    ...
                    <div class="col-lg-6 order-lg-1 my-auto  showcase-text">
                        ...
                        <p class="lead mb-0 fs-5">Merancang harta dalam Islam bukan sahaja terhad pada kaedah dan tatacara menguruskan perbelanjaan individu atau keluarga bagi kepentingan hidup di dunia sahaja</p>
                    </div>
                </div>
                <div class="row g-0 bg-secondary">
                    ...
                    <div class="col-lg-6 my-auto  showcase-text">
                        <h2>Sambungan</h2>
                        <p class="lead mb-0 fs-5">Merancang harta juga merangkumi bagaimana cara seseorang menguruskan harta dengan cara membuat perancangan yang teratur untuk kesejahteraan hidup di dunia dan di akhirat</p>
                    </div>
                </div>
                <div class="row g-0 bg-secondary">
